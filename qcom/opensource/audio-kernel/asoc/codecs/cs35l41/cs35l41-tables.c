...
const unsigned int cs35l41_ctl_cache_regs[CS35L41_CTRL_CACHE_SIZE] = {
    CS35L41_DAC_PCM1_SRC,     CS35L41_DSP1_RX1_SRC,     CS35L41_DSP1_RX2_SRC,
    CS35L41_ASP_TX1_SRC,      CS35L41_ASP_TX2_SRC,      CS35L41_ASP_TX3_SRC,
    CS35L41_ASP_TX4_SRC,      CS35L41_SP_FRAME_TX_SLOT, CS35L41_AMP_GAIN_CTRL,
    CS35L41_AMP_DIG_VOL_CTRL, CS35L41_PWR_CTRL1,        CS35L41_PWR_CTRL2,
...
const struct cs35l41_otp_trim_region_t
    cs35l41_trim_cache_regs[CS35L41_TRIM_CACHE_REGIONS] = {
        {0x00002030, 1}, {0x0000208c, 2},  {0x0000300C, 1}, {0x0000394C, 5},
        {0x0000416C, 1}, {0x00004160, 1},  {0x00004170, 1}, {0x00004360, 1},
        {0x00004448, 2}, {0x00006E30, 14}, {0x00007418, 2}, {0x00007434, 1},
        {0x00007068, 1}, {0x0000410C, 1},  {0x0000400C, 1}, {0x00004000, 1},
        {0x00017040, 2},
};
