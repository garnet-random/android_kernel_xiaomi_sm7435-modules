...
static const struct cs35l41_pll_sysclk_config cs35l41_pll_sysclk[] = {
    {32768, 0x00},    {8000, 0x01},     {11025, 0x02},    {12000, 0x03},
    {16000, 0x04},    {22050, 0x05},    {24000, 0x06},    {32000, 0x07},
    {44100, 0x08},    {48000, 0x09},    {88200, 0x0A},    {96000, 0x0B},
    {128000, 0x0C},   {176400, 0x0D},   {192000, 0x0E},   {256000, 0x0F},
    {352800, 0x10},   {384000, 0x11},   {512000, 0x12},   {705600, 0x13},
    {750000, 0x14},   {768000, 0x15},   {1000000, 0x16},  {1024000, 0x17},
    {1200000, 0x18},  {1411200, 0x19},  {1500000, 0x1A},  {1536000, 0x1B},
    {2000000, 0x1C},  {2048000, 0x1D},  {2400000, 0x1E},  {2822400, 0x1F},
    {3000000, 0x20},  {3072000, 0x21},  {3200000, 0x22},  {4000000, 0x23},
    {4096000, 0x24},  {4800000, 0x25},  {5644800, 0x26},  {6000000, 0x27},
    {6144000, 0x28},  {6250000, 0x29},  {6400000, 0x2A},  {6500000, 0x2B},
    {6750000, 0x2C},  {7526400, 0x2D},  {8000000, 0x2E},  {8192000, 0x2F},
    {9600000, 0x30},  {11289600, 0x31}, {12000000, 0x32}, {12288000, 0x33},
    {12500000, 0x34}, {12800000, 0x35}, {13000000, 0x36}, {13500000, 0x37},
    {19200000, 0x38}, {22579200, 0x39}, {24000000, 0x3A}, {24576000, 0x3B},
    {25000000, 0x3C}, {25600000, 0x3D}, {26000000, 0x3E}, {27000000, 0x3F},
};
...
static const struct cs35l41_fs_mon_config cs35l41_fs_mon[] = {
    {32768, 2254, 3754},  {8000, 9220, 15364}, {11025, 6148, 10244},
    {12000, 6148, 10244}, {16000, 4612, 7684}, {22050, 3076, 5124},
    {24000, 3076, 5124},  {32000, 2308, 3844}, {44100, 1540, 2564},
    {48000, 1540, 2564},  {88200, 772, 1284},  {96000, 772, 1284},
    {128000, 580, 964},   {176400, 388, 644},  {192000, 388, 644},
    {256000, 292, 484},   {352800, 196, 324},  {384000, 196, 324},
    {512000, 148, 244},   {705600, 100, 164},  {750000, 100, 164},
    {768000, 100, 164},   {1000000, 76, 124},  {1024000, 76, 124},
    {1200000, 64, 104},   {1411200, 52, 84},   {1500000, 52, 84},
    {1536000, 52, 84},    {2000000, 40, 64},   {2048000, 40, 64},
    {2400000, 34, 54},    {2822400, 28, 44},   {3000000, 28, 44},
    {3072000, 28, 44},    {3200000, 27, 42},   {4000000, 22, 34},
    {4096000, 22, 34},    {4800000, 19, 29},   {5644800, 16, 24},
    {6000000, 16, 24},    {6144000, 16, 24},
};
...
static int cs35l41_amp_reset_put(struct snd_kcontrol *kcontrol,
  ...
  do {
    if (timeout == 0) {
      dev_err(cs35l41->dev, "Timeout waiting for OTP_BOOT_DONE\n");
      return -EBUSY;
    }
  ...
  /* Reset DSP */
  regmap_update_bits(cs35l41->regmap, CS35L41_DSP_CLK_CTRL, 0x3, 0x2);
  regmap_update_bits(cs35l41->regmap, CS35L41_DSP1_CCM_CORE_CTRL,
                     CS35L41_HALO_CORE_RESET, CS35L41_HALO_CORE_RESET);
  regmap_update_bits(cs35l41->regmap, CS35L41_DSP_CLK_CTRL, 0x3, 0x3);
...
static int cs35l41_ccm_reset_put(struct snd_kcontrol *kcontrol,
  ...
  if (val) {
    ret = regmap_update_bits(cs35l41->regmap, CS35L41_DSP_CLK_CTRL, 0x3, 0x2);
    ret = regmap_update_bits(cs35l41->regmap, CS35L41_DSP1_CCM_CORE_CTRL,
                             CS35L41_HALO_CORE_RESET, CS35L41_HALO_CORE_RESET);
    ret = regmap_update_bits(cs35l41->regmap, CS35L41_DSP_CLK_CTRL, 0x3, 0x3);
  }
...
static int
cs35l41_hibernate_force_wake_get(struct snd_kcontrol *kcontrol,
                                 struct snd_ctl_elem_value *ucontrol) {
  struct snd_soc_component *component = snd_soc_kcontrol_component(kcontrol);
  struct cs35l41_private *cs35l41 = snd_soc_component_get_drvdata(component);
...
static int
cs35l41_hibernate_force_wake_put(struct snd_kcontrol *kcontrol,
                                 struct snd_ctl_elem_value *ucontrol) {
  struct snd_soc_component *component = snd_soc_kcontrol_component(kcontrol);
  struct cs35l41_private *cs35l41 = snd_soc_component_get_drvdata(component);
  ...
  if (cs35l41->amp_hibernate == CS35L41_HIBERNATE_AWAKE ||
    ...
    if (!cs35l41->hibernate_force_wake && valid_transition &&
      ...
      /* return to standby */
      queue_delayed_work(cs35l41->wq, &cs35l41->hb_work, msecs_to_jiffies(100));
    }
...
static int cs35l41_do_fast_switch(struct cs35l41_private *cs35l41) {
  ...
  wm_adsp_write_ctl(&cs35l41->dsp, "CSPL_UPDATE_PARAMS_CONFIG", WMFW_ADSP2_YM,
                    0xcd, data_ctl_buf, data_ctl_len * sizeof(s32));

  dev_dbg(cs35l41->dev, "Wrote %u reg for CSPL_UPDATE_PARAMS_CONFIG\n",
          data_ctl_len);

#ifdef DEBUG
  wm_adsp_read_ctl(&cs35l41->dsp, "CSPL_UPDATE_PARAMS_CONFIG", WMFW_ADSP2_YM,
                   0xcd, data_ctl_buf, data_ctl_len * sizeof(s32));
  ...
  wm_adsp_write_ctl(&cs35l41->dsp, "CSPL_COMMAND", WMFW_ADSP2_XM, 0xcd,
                    &cmd_ctl, sizeof(s32));

  /* Verify CSPL COMMAND */
  for (i = 0; i < 5; i++) {
    wm_adsp_read_ctl(&cs35l41->dsp, "CSPL_STATE", WMFW_ADSP2_XM, 0xcd, &st_ctl,
                     sizeof(s32));
...
static void cs35l41_fast_switch_file_put_work(struct work_struct *wk) {
  ...
  struct cs35l41_private *cs35l41 =
      container_of(dsp, struct cs35l41_private, dsp);

  if (!dsp->running) {
    left_jiffies = wait_for_completion_timeout(&dsp->halo_booted_done,
                                               msecs_to_jiffies(500));
    waited_ms = jiffies_to_msecs(msecs_to_jiffies(500) - left_jiffies);
    dev_info(cs35l41->dev,
             "%s: ### Waited %d ms till Halo intialized when downloading delta "
             "tuning",
             __func__, waited_ms);
...
static int cs35l41_set_csplmboxcmd(struct cs35l41_private *cs35l41,
  ...
  for (i = 0; i < 5; i++) {
    ...
    if (sts & (1 << CS35L41_CSPL_MBOX_CMD_FW_SHIFT)) {
      dev_dbg(cs35l41->dev, "%u: Received ACK in EINT for mbox cmd (%d)\n", i,
              cmd);
      regmap_write(cs35l41->regmap, CS35L41_IRQ1_STATUS2,
                   1 << CS35L41_CSPL_MBOX_CMD_FW_SHIFT);
      ack = true;
  ...
  if (!ack) {
    dev_err(cs35l41->dev, "Timeout waiting for DSP to set mbox cmd\n");
    ret = -ETIMEDOUT;
  }
  ...
  if (!cs35l41_is_csplmboxsts_correct(cmd, (enum cs35l41_cspl_mboxstate)sts)) {
    dev_err(cs35l41->dev, "Failed to set mailbox(cmd: %u, sts: %u)\n", cmd,
            sts);
    ret = -ENOMSG;
  }
...
static int cs35l41_put_output_dev(struct snd_kcontrol *kcontrol,
  ...
  if (atomic_read(&cs35l41->vol_ctl.playback) &&
    ...
    queue_work(cs35l41->vol_ctl.ramp_wq, &cs35l41->vol_ctl.ramp_work);
  }
...
static void cs35l41_vol_ramp(struct work_struct *wk) {
  ...
  /* 1/8 dB minimum step */
  init_y_knee =
      (long)(cs35l41->vol_ctl.dig_vol - cs35l41->vol_ctl.ramp_init_att * 8);
  if (init_y_knee < 0)
    /* Hit floor */
    init_y_knee = 0;
  init_y_end =
      (long)(cs35l41->vol_ctl.dig_vol - cs35l41->vol_ctl.ramp_knee_att * 8);
  if (init_y_end < 0)
    /* Hit floor */
    init_y_end = 0;
...
static int cs35l41_put_vol(struct snd_kcontrol *kcontrol,
  ...
  if (atomic_read(&cs35l41->vol_ctl.vol_ramp) == 0) {
    cs35l41->vol_ctl.dig_vol = (int)ucontrol->value.integer.value[0];
    cs35l41_set_vol(cs35l41->vol_ctl.dig_vol, cs35l41);
  }
...
static int cs35l41_put_manual_ramp(struct snd_kcontrol *kcontrol,
  ...
  atomic_set(&cs35l41->vol_ctl.manual_ramp, ucontrol->value.integer.value[0]);
...
static int cs35l41_put_init_attenuation(struct snd_kcontrol *kcontrol,
  ...
  if (atomic_read(&cs35l41->vol_ctl.vol_ramp) == 0)
    cs35l41->vol_ctl.ramp_init_att = (int)ucontrol->value.integer.value[0];
  return 0;
}
...
static int cs35l41_put_knee_attenuation(struct snd_kcontrol *kcontrol,
  ...
  if (atomic_read(&cs35l41->vol_ctl.vol_ramp) == 0)
    cs35l41->vol_ctl.ramp_knee_att = (int)ucontrol->value.integer.value[0];
  return 0;
}
...
static int cs35l41_get_auto_ramp_timeout(struct snd_kcontrol *kcontrol,
  ...
  ucontrol->value.integer.value[0] = (long)cs35l41->vol_ctl.auto_ramp_timeout;
  return 0;
}
...
static int cs35l41_get_ramp_knee_time(struct snd_kcontrol *kcontrol,
  ...
  ucontrol->value.integer.value[0] = (long)cs35l41->vol_ctl.ramp_knee_time;
  return 0;
}
...
static int cs35l41_channel_swap_put(struct snd_kcontrol *kcontrol,
  ...
  if (cs35l41->dsp.booted) {
    ...
    val = cpu_to_be32(val);
    wm_adsp_write_ctl(&cs35l41->dsp, "CH_BAL", WMFW_ADSP2_XM, 0xcd,
                      (void *)&val, sizeof(__be32));
  }
...
static int cs35l41_channel_swap_get(struct snd_kcontrol *kcontrol,
  ...
  if (cs35l41->dsp.booted) {
    wm_adsp_read_ctl(&cs35l41->dsp, "CH_BAL", WMFW_ADSP2_XM, 0xcd, (void *)&val,
                     sizeof(__be32));
...
static const struct snd_kcontrol_new cs35l41_aud_controls[] = {
    ...
    SOC_SINGLE_TLV("AMP PCM Gain", CS35L41_AMP_GAIN_CTRL, 5, 0x14, 0,
                   amp_gain_tlv),
    SOC_SINGLE_RANGE("ASPTX1 Slot Position", CS35L41_SP_FRAME_TX_SLOT, 0, 0, 7,
                     0),
    SOC_SINGLE_RANGE("ASPTX2 Slot Position", CS35L41_SP_FRAME_TX_SLOT, 8, 0, 7,
                     0),
    SOC_SINGLE_RANGE("ASPTX3 Slot Position", CS35L41_SP_FRAME_TX_SLOT, 16, 0, 7,
                     0),
    SOC_SINGLE_RANGE("ASPTX4 Slot Position", CS35L41_SP_FRAME_TX_SLOT, 24, 0, 7,
                     0),
    SOC_SINGLE_RANGE("ASPRX1 Slot Position", CS35L41_SP_FRAME_RX_SLOT, 0, 0, 7,
                     0),
    SOC_SINGLE_RANGE("ASPRX2 Slot Position", CS35L41_SP_FRAME_RX_SLOT, 8, 0, 7,
                     0),
    SOC_ENUM("PCM Soft Ramp", pcm_sft_ramp),
    SOC_SINGLE_EXT("DSP Booted", SND_SOC_NOPM, 0, 1, 0, cs35l41_halo_booted_get,
                   cs35l41_halo_booted_put),
    SOC_SINGLE_EXT("AMP Reset", SND_SOC_NOPM, 0, 1, 0, cs35l41_amp_reset_get,
                   cs35l41_amp_reset_put),
    ...
    SOC_ENUM_EXT("Channel Swap", channel_swap_enum, cs35l41_channel_swap_get,
                 cs35l41_channel_swap_put),
    ...
    SOC_SINGLE("Boost Class-H Tracking Enable", CS35L41_BSTCVRT_VCTRL2, 0, 1,
               0),
    SOC_SINGLE("Boost Target Voltage", CS35L41_BSTCVRT_VCTRL1, 0, 0xAA, 0),
    WM_ADSP2_PRELOAD_SWITCH("DSP1", 1),
    WM_ADSP_FW_CONTROL("DSP1", 0),
    SOC_SINGLE_BOOL_EXT("Safety Volume Ramp Status", 0, cs35l41_get_ramp_status,
                        cs35l41_put_ramp_status),
    ...
    SOC_SINGLE_EXT("Ramp Knee Time", SND_SOC_NOPM, 0,
                   CS35L41_MAX_AUTO_RAMP_TIMEOUT, 0, cs35l41_get_ramp_knee_time,
                   cs35l41_put_ramp_knee_time),
    SOC_SINGLE_EXT("Ramp End Time", SND_SOC_NOPM, 0,
                   CS35L41_MAX_AUTO_RAMP_TIMEOUT, 0, cs35l41_get_ramp_end_time,
                   cs35l41_put_ramp_end_time),
    ...
    SOC_SINGLE_EXT("AMP Active Status", SND_SOC_NOPM, 0, 1, 0,
                   cs35l41_amp_active_status_get,
                   cs35l41_amp_active_status_put),
    ...
    SOC_SINGLE_EXT("Enable RCV Pin Control", SND_SOC_NOPM, 0, 1, 0,
                   cs35l41_rcv_switch_pinctrl_get,
                   cs35l41_rcv_switch_pinctrl_put),
...
cs35l41_find_otp_map(u32 otp_id) {
  int i;
...
static int cs35l41_otp_unpack(void *data) {
  ...
  for (i = 0; i < otp_map_match->num_elements; i++) {
    // dev_dbg(cs35l41->dev, "bitoffset= %d, word_offset=%d, bit_sum mod
    // 32=%d\n", 		bit_offset, word_offset, bit_sum % 32);
    if (bit_offset + otp_map[i].size - 1 >= 32) {
      otp_val = (otp_mem[word_offset] & GENMASK(31, bit_offset)) >> bit_offset;
  ...
  otp_retry:
    if (otp_map[i].reg != 0) {
      ret = regmap_update_bits(
          ...
          GENMASK(otp_map[i].shift + otp_map[i].size - 1, otp_map[i].shift),
          otp_val << otp_map[i].shift);
      if (ret < 0) {
        dev_info(cs35l41->dev,
                 "OTP[%d]: bitoffset=%d, word_offset=%d, bit_sum mod 32=%d\n"
                 "reg=0x%x, size=%d, shift=%d\n",
                 i, bit_offset, word_offset, bit_sum % 32, otp_map[i].reg,
                 otp_map[i].size, otp_map[i].shift);
...
static irqreturn_t cs35l41_irq(int irq, void *data) {
  ...
  for (i = 0; i < ARRAY_SIZE(status); i++) {
    regmap_read(cs35l41->regmap, CS35L41_IRQ1_STATUS1 + (i * CS35L41_REGSTRIDE),
                &status[i]);
    regmap_read(cs35l41->regmap, CS35L41_IRQ1_MASK1 + (i * CS35L41_REGSTRIDE),
                &masks[i]);
  }
  ...
  if (status[0] & CS35L41_AMP_SHORT_ERR) {
    ...
    if (cs35l41->amp_short == 0)
      cs35l41->amp_short = 1;
    regmap_write(cs35l41->regmap, CS35L41_IRQ1_STATUS1, CS35L41_AMP_SHORT_ERR);
    regmap_write(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN, 0);
    regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN,
                       CS35L41_AMP_SHORT_ERR_RLS, CS35L41_AMP_SHORT_ERR_RLS);
    regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN,
  ...
  if (status[0] & CS35L41_TEMP_WARN) {
    ...
    regmap_write(cs35l41->regmap, CS35L41_IRQ1_STATUS1, CS35L41_TEMP_WARN);
    regmap_write(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN, 0);
    regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN,
  ...
  if (status[0] & CS35L41_TEMP_ERR) {
    ...
    regmap_write(cs35l41->regmap, CS35L41_IRQ1_STATUS1, CS35L41_TEMP_ERR);
    regmap_write(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN, 0);
    regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN,
  ...
  if (status[0] & CS35L41_BST_OVP_ERR) {
    ...
    regmap_update_bits(cs35l41->regmap, CS35L41_PWR_CTRL2, CS35L41_BST_EN_MASK,
                       0);
    regmap_write(cs35l41->regmap, CS35L41_IRQ1_STATUS1, CS35L41_BST_OVP_ERR);
    regmap_write(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN, 0);
    regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN,
                       CS35L41_BST_OVP_ERR_RLS, CS35L41_BST_OVP_ERR_RLS);
    regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN,
  ...
  if (status[0] & CS35L41_BST_DCM_UVP_ERR) {
    ...
    regmap_write(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN, 0);
    regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN,
                       CS35L41_BST_UVP_ERR_RLS, CS35L41_BST_UVP_ERR_RLS);
    regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN,
  ...
  if (status[0] & CS35L41_BST_SHORT_ERR) {
    ...
    regmap_update_bits(cs35l41->regmap, CS35L41_PWR_CTRL2, CS35L41_BST_EN_MASK,
                       0);
    regmap_write(cs35l41->regmap, CS35L41_IRQ1_STATUS1, CS35L41_BST_SHORT_ERR);
    regmap_write(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN, 0);
    regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN,
...
static int cs35l41_hibernate(struct snd_soc_dapm_widget *w,
  ...
  case SND_SOC_DAPM_POST_PMD:
    queue_delayed_work(cs35l41->wq, &cs35l41->hb_work, msecs_to_jiffies(2000));
    break;
  default:
  ...
  if (cs35l41->vol_ctl.prev_active_dev == CS35L41_OUTPUT_DEV_RCV &&
    ...
    if (cs35l41->vol_ctl.auto_ramp_timeout == 0) {
      ...
      if (elapsed_time < dev_timeout)
        ramp = true;
      dev_dbg(cs35l41->dev, "elapsed_time:%lld dev_timeout:%lld\n",
...
static int cs35l41_main_amp_event(struct snd_soc_dapm_widget *w,
  ...
  case SND_SOC_DAPM_POST_PMU:
    ...
    regmap_update_bits(cs35l41->regmap, CS35L41_PWR_CTRL1,
                       CS35L41_GLOBAL_EN_MASK, 1 << CS35L41_GLOBAL_EN_SHIFT);
  ...
  case SND_SOC_DAPM_POST_PMD:
    ...
    if (cs35l41->vol_ctl.output_dev == CS35L41_OUTPUT_DEV_RCV &&
        cs35l41->vol_ctl.auto_ramp_timeout > 0 &&
        cs35l41->vol_ctl.auto_ramp_timeout < CS35L41_MAX_AUTO_RAMP_TIMEOUT)
...
static int cs35l41_set_dai_fmt(struct snd_soc_dai *codec_dai,
                               unsigned int fmt) {
  struct cs35l41_private *cs35l41 =
  ...
  regmap_update_bits(cs35l41->regmap, CS35L41_SP_FORMAT, CS35L41_ASP_FMT_MASK,
                     asp_fmt << CS35L41_ASP_FMT_SHIFT);

  regmap_update_bits(cs35l41->regmap, CS35L41_SP_FORMAT, CS35L41_SCLK_MSTR_MASK,
  ...
  regmap_update_bits(cs35l41->regmap, CS35L41_SP_FORMAT, CS35L41_LRCLK_INV_MASK,
                     lrclk_fmt << CS35L41_LRCLK_INV_SHIFT);
  regmap_update_bits(cs35l41->regmap, CS35L41_SP_FORMAT, CS35L41_SCLK_INV_MASK,
...
static const struct cs35l41_global_fs_config cs35l41_fs_rates[] = {
    {12000, 0x01}, {24000, 0x02}, {48000, 0x03}, {96000, 0x04}, {192000, 0x05},
    {11025, 0x09}, {22050, 0x0A}, {44100, 0x0B}, {88200, 0x0C}, {176400, 0x0D},
    {8000, 0x11},  {16000, 0x12}, {32000, 0x13},
};
...
static int cs35l41_pcm_startup(struct snd_pcm_substream *substream,
  ...
  if (substream->runtime)
    return snd_pcm_hw_constraint_list(
        substream->runtime, 0, SNDRV_PCM_HW_PARAM_RATE, &cs35l41_constraints);
  return 0;
}
...
static int cs35l41_component_set_sysclk(struct snd_soc_component *component,
  ...
  regmap_update_bits(cs35l41->regmap, CS35L41_PLL_CLK_CTRL,
                     CS35L41_PLL_CLK_EN_MASK, 0 << CS35L41_PLL_CLK_EN_SHIFT);
  regmap_update_bits(cs35l41->regmap, CS35L41_PLL_CLK_CTRL,
...
static int cs35l41_boost_config(struct cs35l41_private *cs35l41, int boost_ind,
  ...
  ret = regmap_update_bits(regmap, CS35L41_BSTCVRT_COEFF, CS35L41_BST_K1_MASK,
  ...
  ret = regmap_update_bits(regmap, CS35L41_BSTCVRT_COEFF, CS35L41_BST_K2_MASK,
  ...
  ret = regmap_update_bits(
      regmap, CS35L41_BSTCVRT_SLOPE_LBST, CS35L41_BST_SLOPE_MASK,
      cs35l41_bst_slope_table[bst_lbst_val] << CS35L41_BST_SLOPE_SHIFT);
  if (ret) {
  ...
  ret =
      regmap_update_bits(regmap, CS35L41_BSTCVRT_PEAK_CUR, CS35L41_BST_IPK_MASK,
...
static int cs35l41_set_pdata(struct cs35l41_private *cs35l41) {
  ...
  if (cs35l41->pdata.temp_warn_thld)
    regmap_update_bits(cs35l41->regmap, CS35L41_DTEMP_WARN_THLD,
                       CS35L41_TEMP_THLD_MASK, cs35l41->pdata.temp_warn_thld);
  ...
  if (cs35l41->pdata.hw_ng_sel)
    regmap_update_bits(cs35l41->regmap, CS35L41_NG_CFG, CS35L41_HW_NG_SEL_MASK,
                       cs35l41->pdata.hw_ng_sel << CS35L41_HW_NG_SEL_SHIFT);

  if (cs35l41->pdata.hw_ng_thld)
    regmap_update_bits(cs35l41->regmap, CS35L41_NG_CFG, CS35L41_HW_NG_THLD_MASK,
                       cs35l41->pdata.hw_ng_thld << CS35L41_HW_NG_THLD_SHIFT);

  if (cs35l41->pdata.hw_ng_delay)
    regmap_update_bits(cs35l41->regmap, CS35L41_NG_CFG, CS35L41_HW_NG_DLY_MASK,
                       cs35l41->pdata.hw_ng_delay << CS35L41_HW_NG_DLY_SHIFT);

  if (classh->classh_algo_enable) {
    if (classh->classh_bst_override)
      regmap_update_bits(cs35l41->regmap, CS35L41_BSTCVRT_VCTRL2,
                         CS35L41_BST_CTL_SEL_MASK, CS35L41_BST_CTL_SEL_REG);
    if (classh->classh_bst_max_limit)
      regmap_update_bits(cs35l41->regmap, CS35L41_BSTCVRT_VCTRL2,
                         CS35L41_BST_LIM_MASK,
                         classh->classh_bst_max_limit << CS35L41_BST_LIM_SHIFT);
    if (classh->classh_mem_depth)
      regmap_update_bits(
          cs35l41->regmap, CS35L41_CLASSH_CFG, CS35L41_CH_MEM_DEPTH_MASK,
          classh->classh_mem_depth << CS35L41_CH_MEM_DEPTH_SHIFT);
    if (classh->classh_headroom)
      regmap_update_bits(cs35l41->regmap, CS35L41_CLASSH_CFG,
                         CS35L41_CH_HDRM_CTL_MASK,
                         classh->classh_headroom << CS35L41_CH_HDRM_CTL_SHIFT);
    if (classh->classh_release_rate)
      regmap_update_bits(
          cs35l41->regmap, CS35L41_CLASSH_CFG, CS35L41_CH_REL_RATE_MASK,
          classh->classh_release_rate << CS35L41_CH_REL_RATE_SHIFT);
    if (classh->classh_wk_fet_delay)
      regmap_update_bits(
          cs35l41->regmap, CS35L41_WKFET_CFG, CS35L41_CH_WKFET_DLY_MASK,
          classh->classh_wk_fet_delay << CS35L41_CH_WKFET_DLY_SHIFT);
    if (classh->classh_wk_fet_thld)
      regmap_update_bits(
          cs35l41->regmap, CS35L41_WKFET_CFG, CS35L41_CH_WKFET_THLD_MASK,
          classh->classh_wk_fet_thld << CS35L41_CH_WKFET_THLD_SHIFT);
  }
...
static int cs35l41_component_probe(struct snd_soc_component *component) {
  ...
  if (ret < 0)
    dev_err(cs35l41->dev, "snd_soc_add_codec_controls failed (%d)\n", ret);
  kfree(kcontrol);
...
static int cs35l41_irq_gpio_config(struct cs35l41_private *cs35l41) {
  ...
  if (irq_gpio_cfg1->is_present) {
    if (irq_gpio_cfg1->irq_pol_inv)
      regmap_update_bits(cs35l41->regmap, CS35L41_GPIO1_CTRL1,
                         CS35L41_GPIO_POL_MASK, CS35L41_GPIO_POL_MASK);
    if (irq_gpio_cfg1->irq_out_en)
      regmap_update_bits(cs35l41->regmap, CS35L41_GPIO1_CTRL1,
                         CS35L41_GPIO_DIR_MASK, 0);
    if (irq_gpio_cfg1->irq_src_sel)
      regmap_update_bits(
          cs35l41->regmap, CS35L41_GPIO_PAD_CONTROL, CS35L41_GPIO1_CTRL_MASK,
  ...
  if (irq_gpio_cfg2->is_present) {
    ...
    if (irq_gpio_cfg2->irq_src_sel)
      regmap_update_bits(
          cs35l41->regmap, CS35L41_GPIO_PAD_CONTROL, CS35L41_GPIO2_CTRL_MASK,
...
static int cs35l41_handle_of_data(struct device *dev,
  ...
  cs35l41->dt_name = devm_kstrdup_const(cs35l41->dev, np->name, GFP_KERNEL);
  ...
  if (ret < 0) {
    ...
    cs35l41->fast_switch_enum.items = ARRAY_SIZE(cs35l41_fast_switch_text);
    ...
    cs35l41->fast_switch_names =
        devm_kmalloc(dev, num_fast_switch * sizeof(char *), GFP_KERNEL);
    if (!cs35l41->fast_switch_names)
      return -ENOMEM;
    of_property_read_string_array(np, "cirrus,fast-switch",
                                  cs35l41->fast_switch_names, num_fast_switch);
    for (i = 0; i < num_fast_switch; i++) {
      dev_info(dev, "%d:%s\n", i, cs35l41->fast_switch_names[i]);
    }
  ...
  pdata->right_channel = of_property_read_bool(np, "cirrus,right-channel-amp");
  pdata->sclk_frc = of_property_read_bool(np, "cirrus,sclk-force-output");
  pdata->lrclk_frc = of_property_read_bool(np, "cirrus,lrclk-force-output");
  ...
  if (classh_config->classh_algo_enable) {
    classh_config->classh_bst_override =
        of_property_read_bool(sub_node, "cirrus,classh-bst-override");

    ret = of_property_read_u32(sub_node, "cirrus,classh-bst-max-limit", &val);
    if (ret >= 0) {
      val |= CS35L41_VALID_PDATA;
      classh_config->classh_bst_max_limit = val;
    }

    ret = of_property_read_u32(sub_node, "cirrus,classh-mem-depth", &val);
    if (ret >= 0) {
      val |= CS35L41_VALID_PDATA;
      classh_config->classh_mem_depth = val;
    }

    ret = of_property_read_u32(sub_node, "cirrus,classh-release-rate", &val);
    if (ret >= 0)
      classh_config->classh_release_rate = val;

    ret = of_property_read_u32(sub_node, "cirrus,classh-headroom", &val);
    if (ret >= 0) {
      val |= CS35L41_VALID_PDATA;
      classh_config->classh_headroom = val;
    }

    ret = of_property_read_u32(sub_node, "cirrus,classh-wk-fet-delay", &val);
    if (ret >= 0) {
      val |= CS35L41_VALID_PDATA;
      classh_config->classh_wk_fet_delay = val;
    }

    ret = of_property_read_u32(sub_node, "cirrus,classh-wk-fet-thld", &val);
    if (ret >= 0)
  ...
  if (irq_gpio1_config->is_present) {
    irq_gpio1_config->irq_pol_inv =
        of_property_read_bool(sub_node, "cirrus,gpio-polarity-invert");
    irq_gpio1_config->irq_out_en =
        of_property_read_bool(sub_node, "cirrus,gpio-output-enable");
    ret = of_property_read_u32(sub_node, "cirrus,gpio-src-select", &val);
    if (ret >= 0) {
      val |= CS35L41_VALID_PDATA;
  ...
  if (irq_gpio2_config->is_present) {
    irq_gpio2_config->irq_pol_inv =
        of_property_read_bool(sub_node, "cirrus,gpio-polarity-invert");
    irq_gpio2_config->irq_out_en =
        of_property_read_bool(sub_node, "cirrus,gpio-output-enable");
    ret = of_property_read_u32(sub_node, "cirrus,gpio-src-select", &val);
    if (ret >= 0) {
      val |= CS35L41_VALID_PDATA;
...
static const struct reg_sequence cs35l41_fs_errata_patch[] = {
    {0x02B80080, 0x00000001}, {0x02B80088, 0x00000001},
    {0x02B80090, 0x00000001}, {0x02B80098, 0x00000001},
    {0x02B800A0, 0x00000001}, {0x02B800A8, 0x00000001},
    {0x02B800B0, 0x00000001}, {0x02B800B8, 0x00000001},
    {0x02B80280, 0x00000001}, {0x02B80288, 0x00000001},
    {0x02B80290, 0x00000001}, {0x02B80298, 0x00000001},
    {0x02B802A0, 0x00000001}, {0x02B802A8, 0x00000001},
    {0x02B802B0, 0x00000001}, {0x02B802B8, 0x00000001},
};
...
static int cs35l41_wait_for_pwrmgt_sts(struct cs35l41_private *cs35l41) {
  ...
  for (i = 0; (i < 10) && (wrpend_sts & 0x2); i++)
    ret = regmap_read(cs35l41->regmap, CS35L41_PWRMGT_STS, &wrpend_sts);
  return ret;
}
...
static int cs35l41_exit_hibernate(struct cs35l41_private *cs35l41) {
  ...
  do {
    do {
      ret = regmap_write(cs35l41->regmap, CS35L41_CSPL_MBOX_CMD_DRV,
      ...
      ret = regmap_read(cs35l41->regmap, CS35L41_CSPL_MBOX_STS, &status);
      if (ret < 0)
        dev_err(cs35l41->dev, "%s: mbox status read fail\n", __func__);
  ...
  for (i = 0; i < CS35L41_TRIM_CACHE_REGIONS; i++) {
    regmap_raw_write(cs35l41->regmap, cs35l41_trim_cache_regs[i].reg,
                     p_trim_data,
...
static int cs35l41_restore(struct cs35l41_private *cs35l41) {
  ...
  case CS35L41_REVID_A0:
    ret = regmap_multi_reg_write(cs35l41->regmap, cs35l41_reva0_errata_patch,
  ...
  case CS35L41_REVID_B0:
    ret = regmap_multi_reg_write(cs35l41->regmap, cs35l41_revb0_errata_patch,
                                 ARRAY_SIZE(cs35l41_revb0_errata_patch));
    if (ret < 0) {
      dev_err(cs35l41->dev, "Failed to apply B0 errata patch %d\n", ret);
    }
    break;
  case CS35L41_REVID_B2:
    ret = regmap_multi_reg_write(cs35l41->regmap, cs35l41_revb2_errata_patch,
                                 ARRAY_SIZE(cs35l41_revb2_errata_patch));
    if (ret < 0) {
      dev_err(cs35l41->dev, "Failed to apply B2 errata patch %d\n", ret);
    }
    break;
  }
  ...
  regmap_update_bits(
      cs35l41->regmap, CS35L41_SP_FRAME_RX_SLOT, CS35L41_ASP_RX1_SLOT_MASK,
      ((cs35l41->pdata.right_channel) ? 1 : 0) << CS35L41_ASP_RX1_SLOT_SHIFT);
  regmap_update_bits(
      cs35l41->regmap, CS35L41_SP_FRAME_RX_SLOT, CS35L41_ASP_RX2_SLOT_MASK,
      ((cs35l41->pdata.right_channel) ? 0 : 1) << CS35L41_ASP_RX2_SLOT_SHIFT);
  ...
  if (cs35l41->reset_cache.extclk_cfg) {
    ...
    if (cs35l41->clksrc == CS35L41_PLLSRC_SCLK)
      regmap_update_bits(cs35l41->regmap, CS35L41_SP_RATE_CTRL, 0x3F,
                         cs35l41->extclk_cfg);
  ...
  if (cs35l41->reset_cache.asp_width >= 0) {
    regmap_update_bits(
        cs35l41->regmap, CS35L41_SP_FORMAT, CS35L41_ASP_WIDTH_RX_MASK,
        cs35l41->reset_cache.asp_width << CS35L41_ASP_WIDTH_RX_SHIFT);
    regmap_update_bits(
        cs35l41->regmap, CS35L41_SP_FORMAT, CS35L41_ASP_WIDTH_TX_MASK,
        cs35l41->reset_cache.asp_width << CS35L41_ASP_WIDTH_TX_SHIFT);
  }

  if (cs35l41->reset_cache.asp_wl >= 0) {
    regmap_update_bits(cs35l41->regmap, CS35L41_SP_RX_WL,
                       CS35L41_ASP_RX_WL_MASK,
                       cs35l41->reset_cache.asp_wl << CS35L41_ASP_RX_WL_SHIFT);
    regmap_update_bits(cs35l41->regmap, CS35L41_SP_TX_WL,
                       CS35L41_ASP_TX_WL_MASK,
                       cs35l41->reset_cache.asp_wl << CS35L41_ASP_TX_WL_SHIFT);
  }
  ...
  if (cs35l41->reset_cache.lrclk_fmt >= 0)
    regmap_update_bits(
        cs35l41->regmap, CS35L41_SP_FORMAT, CS35L41_LRCLK_INV_MASK,
        cs35l41->reset_cache.lrclk_fmt << CS35L41_LRCLK_INV_SHIFT);

  if (cs35l41->reset_cache.sclk_fmt >= 0)
    regmap_update_bits(cs35l41->regmap, CS35L41_SP_FORMAT,
                       CS35L41_SCLK_INV_MASK,
                       cs35l41->reset_cache.sclk_fmt << CS35L41_SCLK_INV_SHIFT);

  if (cs35l41->reset_cache.clock_mode >= 0) {
    regmap_update_bits(
        cs35l41->regmap, CS35L41_SP_FORMAT, CS35L41_SCLK_MSTR_MASK,
        cs35l41->reset_cache.clock_mode << CS35L41_SCLK_MSTR_SHIFT);
    regmap_update_bits(
        cs35l41->regmap, CS35L41_SP_FORMAT, CS35L41_LRCLK_MSTR_MASK,
        cs35l41->reset_cache.clock_mode << CS35L41_LRCLK_MSTR_SHIFT);
  }
...
static int cs35l41_preset_sample_rate(struct cs35l41_private *cs35l41,
                                      int rate) {
  int i;
...
static ssize_t cs35l41_amp_short_show(struct device *dev,
  ...
  struct cs35l41_private *cs35l41 = dev_get_drvdata(dev);
  ssize_t len = 0;
  len += snprintf(buf + len, PAGE_SIZE - len, "amp short : %d\n",
                  cs35l41->amp_short);
  return len;
}

static DEVICE_ATTR(amp_short, S_IWUSR | S_IRUGO, cs35l41_amp_short_show,
                   cs35l41_amp_short_store);
static struct attribute *cs35l41_attributes[] = {&dev_attr_amp_short.attr,
                                                 NULL};
...
int cs35l41_probe(struct cs35l41_private *cs35l41,
  ...
  if (pdata) {
    ...
    ret = cs35l41_handle_of_data(cs35l41->dev, &cs35l41->pdata, cs35l41);
    if (ret != 0) {
      ret = -ENODEV;
      goto err;
    }
  ...
  cs35l41->vol_ctl.ramp_wq = create_singlethread_workqueue("cs35l41_ramp");
  ...
  for (i = 0; i < CS35L41_TRIM_CACHE_REGIONS; i++) {
    regmap_raw_read(cs35l41->regmap, cs35l41_trim_cache_regs[i].reg,
                    p_trim_data, cs35l41_trim_cache_regs[i].size * sizeof(u32));
    p_trim_data += cs35l41_trim_cache_regs[i].size;
  }
